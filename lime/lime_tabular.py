    ...
    def explain_instance(self,
        ...
        for label in labels:
            (ret_exp.intercept[label],
             ...
             ret_exp.score, ret_exp.local_pred, ret_exp.easy_model, ret_exp.scaled_data, ret_exp.weights, ret_exp.label_col) = self.base.explain_instance_with_data(
                    scaled_data,
                    yss,
                    distances,
                    label,
    ...
    def __data_inverse(self,
        ...
        if self.discretizer is None:
            ...
            if self.sample_around_instance:
                try:
                    data = data * scale + instance_sample.values
                except:
                    data = data * scale + instance_sample
                #     print(f'Exception {ex} in lime_tabular')
